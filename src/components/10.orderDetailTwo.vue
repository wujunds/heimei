                                        ...
                                        <div class="order-progress">
                                            <ul>
                                                ...
                                                <li :class="{active:orderinfo.status>2}">
                                                    ...
                                                    <div class="info">{{orderinfo.comfirm_time | filterDate('YYYY-MM-DD HH:mm:ss')}}</div>
                                                </li>
                                        ...
                                        <div class="form-box accept-box form-box1">
                                            <dl class="head form-group">
                                                <dd>
                                                    ...
                                                    <router-link v-if="orderinfo.status==1"  :to="'/orderDetail/'+orderinfo.id">去付款</router-link>
                                                    <a href="#" v-if="orderinfo.status>1&&orderinfo.status<4"  @click="signExpress">签收</a>
                                                    <!---->
                                                </dd>
                                            </dl>
                                            <dl class="form-group">
...
export default {
    ...
    methods:{
      getOrderInfo(){
          this.$axios.get(`validate/order/getorderdetial/${this.$route.params.id}`)
          .then(response=>{
      ...
      signExpress(){
          //请求
          this.$axios.get(`validate/order/complate/${this.$route.params.id}`)
          .then(response=>{
            //   console.log(response);
